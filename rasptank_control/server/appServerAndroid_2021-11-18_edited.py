...
connection_check_data = [{"connection":"error", "login":"root", "password":"root"},{"connection":"error", "login":"pi", "password":"raspberry"}]
...
def SocketCommunication():
    ...
    if(onStart):
        connection_check_data = [{"connection":"error", "login":"root", "password":"root"},{"connection":"error", "login":"pi", "password":"raspberry"}]
        tmp = connection_check_data
        tmp_json = json.dumps(tmp)

        # save to file
        try:
            file = open('/home/pi/server/appServer/connection_check.json', "w")
            file.write(tmp_json)
        except:
            print("Write Error - RPY")
        finally:
        ...
        connection_check_data= [{"connection":"ok", "login":"root", "password":"root"},{"connection":"ok", "login":"pi", "password":"raspberry"}]
        tmp = connection_check_data
        tmp_json = json.dumps(tmp)
